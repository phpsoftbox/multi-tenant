...
final readonly class TenantEntityManager implements TenantEntityManagerInterface
{
    ...
    {
        return $this->em()->bulk($entityClass);
    }
    ...
    {
        return $this->em()->findWithDeleted($entityClass, $id);
    }
    ...
    {
        return $this->em()->relationScopeResolver();
    }

    public function manageHydratedEntities(iterable $entities): EntityCollection
    {
        return $this->em()->manageHydratedEntities($entities);
    }
