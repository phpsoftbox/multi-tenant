...
final class DatabaseTenantProviderTest extends TestCase
{
    ...
    public function testLoadTenantsFromDatabase(): void
    {
        $provider = $this->provider(
            ...
            domains: [
                new Domain(id: 1, tenantId: 'tenant-1', domain: 'tenant1.chegdesklad.local', isPrimary: true, enabled: true, data: []),
                new Domain(id: 2, tenantId: 'tenant-1', domain: 'www.tenant1.chegdesklad.local', isPrimary: false, enabled: true, data: []),
                new Domain(id: 3, tenantId: 'tenant-2', domain: 'tenant2.chegdesklad.local', isPrimary: true, enabled: true, data: []),
            ],
        );
    ...
    public function testFindByIdAndHost(): void
    {
        $provider = $this->provider(
            ...
            domains: [
                new Domain(id: 1, tenantId: 'tenant-1', domain: 'tenant1.chegdesklad.local', isPrimary: true, enabled: true),
                new Domain(id: 2, tenantId: 'tenant-1', domain: 'www.tenant1.chegdesklad.local', isPrimary: false, enabled: true),
            ],
        );
        ...
        $this->assertSame('tenant-1', $byPrimaryHost->id);
    ...
    public function testSupportsCustomEntityClasses(): void
    {
        $provider = $this->provider(
            ...
            domains: [
                new CustomDomain(id: 1, tenantId: 'custom-1', domain: 'custom.chegdesklad.local', isPrimary: true, enabled: true),
            ],
        ...
        $this->assertSame('custom-1', $items[0]->id);
