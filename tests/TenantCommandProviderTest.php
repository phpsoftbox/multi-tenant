...
final class TenantCommandProviderTest extends TestCase
{
    ...
    public function testRegistersExpectedCommands(): void
    {
        ...
        $this->assertSame(TenantAuthRoleSyncHandler::class, $registry->get('tenant:auth:role:sync')?->handler);
        $this->assertSame(TenantAuthRoleAssignHandler::class, $registry->get('tenant:auth:role:assign')?->handler);
        $this->assertSame(TenantAuthRoleDischargeHandler::class, $registry->get('tenant:auth:role:discharge')?->handler);
        $this->assertNull($registry->get('tenant:auth:sync'));
